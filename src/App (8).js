...
const HISTORY = [
  ...
  { report_ID: 8780, type: "TYPE3", decision: "혐오", agr: false, completed_at: "오늘 10:02", content: "이미지+텍스트 복합 혐오 표현", image_url: "https://picsum.photos/seed/h3/800/600", varWord: null, bwText: null, htID: 3 },
      ...
      {step === 1 && (
        <div>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <button onClick={() => { setDec("N"); onDone({ report_ID: item.report_ID, content: item.content, image_url: item.image_url, type: "TYPE1", decision: "정상", agr: true, completed_at: new Date().toLocaleTimeString("ko-KR", { hour: "2-digit", minute: "2-digit" }), varWord: null, bwText: null, htID: null }); }}
